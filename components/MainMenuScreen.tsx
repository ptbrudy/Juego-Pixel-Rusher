...
const MainMenuScreen: React.FC<MainMenuScreenProps> = ({ onStartGame, highScores, currentPlayerName, onPlayerChange, allPlayers, isLoading, error }) => {
      ...
      <div className="flex flex-col items-center justify-center bg-black border-4 border-teal-400 rounded-lg p-8 shadow-lg shadow-teal-500/20 h-[640px]">
        ...
        <div className="w-full flex flex-col items-center mt-4">
            ...
            <input
                type="text"
                value={newName}
                onChange={(e) => setNewName(e.target.value.slice(0, 10).toUpperCase())}
  ...
  return (
    <div className="flex flex-col items-center justify-between bg-black border-4 border-teal-400 rounded-lg p-8 shadow-lg shadow-teal-500/20 h-[640px]">
      ...
      <div className="w-full flex flex-col items-center">
        ...
        <button
          onClick={onStartGame}
          disabled={!currentPlayerName || isLoading}
